...
public class Listworkforce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            panel.setText("Register Facial ID");
            ...
            logout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(Listworkforce.this);
                    ...
                    dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Intent intent = new Intent(Listworkforce.this, Admindashboard.class);
    ...
    public String getworkfore( String working ) {
        ...
        String url = "https://punchclock.ai/viewwf.php?cunq="+working;
        ...
        for (int i = 0; i < makebtn; i++) {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Listworkforce.this);
                    ...
                    builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(Listworkforce.this, SurfaceCameraRegister.class);
